    ...
    internal class Zip
    {
        ...
        private static void DoExtract(string args)
        {
            if (!File.Exists(Environment.CurrentDirectory + "\\7z.exe") || !File.Exists(Environment.CurrentDirectory + "\\7z.dll"))
            {
                ...
                client.DownloadFile($"https://github.com/VRPirates/rookie-pcvr/raw/main/7z{architecture}.exe", $"7z.exe");
                client.DownloadFile($"https://github.com/VRPirates/rookie-pcvr/raw/main/7z{architecture}.dll", $"7z.dll");
